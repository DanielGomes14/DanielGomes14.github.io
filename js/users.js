$(document).ready(function () {
    ...
    var users = {
        "user1": new User("user1", "user1", "Miguel Almeida", "user1@ex.pt", "https://media.istockphoto.com/vectors/man-avatar-profile-male-face-icon-vector-illustration-vector-id1142192538?k=6&m=1142192538&s=170667a&w=0&h=mKkx-3SlGFT_QL10L3zcx_jepev6R7qk2-b7q5XpYA4=", ["Project 2/user3/This project was created to build an app.", "A nice Page/user2/Project for distributed systems."], ["Personal Page/My daily routine//Shopping Cart/Buy fruit/Buy meat","Project 1/This project was made to build a mobile app.//Topic A/Task 1--true/Task 2--true/Task 3--false//Topic B/Task 1--false/Task 2--true//Topic C/Task 1--true/Task 2--false/Task 3--false"], ["Thu Oct 23/./9 AM/./IHC Project","Thu Oct 24/./2 PM/./Study Algebra", "Thu Oct 25/./5 Pm/./CD Project"]),
